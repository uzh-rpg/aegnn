...
def is_bbox_zero(bbox: torch.Tensor, limit: float = 10) -> torch.Tensor:
    """Return a mask of zero bounding boxes. Thereby, a bounding box is regarded as 'zero' if
    its shape (width, height) is below a certain threshold in size.
